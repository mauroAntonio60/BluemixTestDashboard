# Testing CRUD operations from the JEE application deployed on Liberty on Bluemix with Cloudant
...
The application shows the results in the form of JSON reponse: 
