...
public class BluemixEnvironment {
    ...
    public static boolean isRunningInBluemix() {
        ...
        if (vcapServices == null) {
        	...
        	System.out.println("--------running in Bluemix");
        	return true;
        }
            ...
            try {
                ...
                while (it.hasNext() && vcapKey == null) {
                    ...
                    if (potentialKey.startsWith("messagehub")) {
                        System.out.println("Using the '" + potentialKey + "' key from VCAP_SERVICES.");//logger.log(Level.INFO, "Using the '" + potentialKey + "' key from VCAP_SERVICES.");
                ...
                if (vcapKey == null) {
                	System.out.println("Error while parsing VCAP_SERVICES: A Message Hub service instance is not bound to this application.");
            	...
            	System.out.println("Failed parsing or processing VCAP_SERVICES "+ e);
                throw e;
            }
    }
